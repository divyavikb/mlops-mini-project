...
docker pull 908928711788.dkr.ecr.ap-southeast-2.amazonaws.com/divyavik_ecr:vupdated
#Stop the old container (if any) 
sudo docker stop divyavik_ecr || true 
sudo docker rm divyavik_ecr || true
Run the new Docker container
docker run -d -p 8888:5000 --name my-app15 -e DAGSHUB_PAT=addfe4700403f70eb2e2bc0e6cb76d67a67606e6  908928711788.dkr.ecr.ap-southeast-2.amazonaws.com/divyavik_ecr:vupdated